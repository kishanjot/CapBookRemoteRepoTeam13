...
<html>
<head>
<title>CapbookProfilePage</title>
<style>
.a {
	width: 500px;
	margin: auto;
...
<form:form action="logoutUser" method="get">
	<b><button type="submit" value="logout"
	onclick="alert('You have logged out!')">Log Out</button></b>
	</form:form>
	
	
	<form method="post" action="${pageContext.request.contextPath}/Uploader" >
	<input type="file" name="file" value="selectImage"/>
...
<div class="navbar">
  ...
  <form:form action="logoutUser" method="get">
	<b><button type="submit" value="logout"
	onclick="alert('Would you like to proceed logout')">Log Out</button></b>
	</form:form>
